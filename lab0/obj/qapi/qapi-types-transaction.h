...
typedef enum TransactionActionKind {
    ...
    TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_MERGE = 5,
    TRANSACTION_ACTION_KIND_BLOCKDEV_BACKUP = 6,
    TRANSACTION_ACTION_KIND_BLOCKDEV_SNAPSHOT = 7,
    TRANSACTION_ACTION_KIND_BLOCKDEV_SNAPSHOT_INTERNAL_SYNC = 8,
    TRANSACTION_ACTION_KIND_BLOCKDEV_SNAPSHOT_SYNC = 9,
    TRANSACTION_ACTION_KIND_DRIVE_BACKUP = 10,
    TRANSACTION_ACTION_KIND__MAX = 11,
...
struct TransactionAction {
    ...
    union { /* union tag is @type */
        ...
        q_obj_BlockDirtyBitmapMerge_wrapper x_block_dirty_bitmap_merge;
