...
typedef enum SysEmuTarget {
    ...
    SYS_EMU_TARGET_RISCV32 = 19,
    SYS_EMU_TARGET_RISCV64 = 20,
    SYS_EMU_TARGET_S390X = 21,
    SYS_EMU_TARGET_SH4 = 22,
    SYS_EMU_TARGET_SH4EB = 23,
    SYS_EMU_TARGET_SPARC = 24,
    SYS_EMU_TARGET_SPARC64 = 25,
    SYS_EMU_TARGET_TRICORE = 26,
    SYS_EMU_TARGET_UNICORE32 = 27,
    SYS_EMU_TARGET_X86_64 = 28,
    SYS_EMU_TARGET_XTENSA = 29,
    SYS_EMU_TARGET_XTENSAEB = 30,
    SYS_EMU_TARGET__MAX = 31,
} SysEmuTarget;
