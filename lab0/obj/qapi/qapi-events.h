...
typedef enum QAPIEvent {
    ...
    QAPI_EVENT_COLO_EXIT = 34,
    QAPI_EVENT_BALLOON_CHANGE = 35,
    QAPI_EVENT_DEVICE_DELETED = 36,
    QAPI_EVENT_DUMP_COMPLETED = 37,
    QAPI_EVENT_MEM_UNPLUG_ERROR = 38,
    QAPI_EVENT_ACPI_DEVICE_OST = 39,
    QAPI_EVENT_RTC_CHANGE = 40,
    QAPI_EVENT_COMMAND_DROPPED = 41,
    QAPI_EVENT__MAX = 42,
} QAPIEvent;
