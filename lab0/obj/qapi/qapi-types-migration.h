...
typedef enum MigrationParameter {
    ...
    MIGRATION_PARAMETER_COMPRESS_WAIT_THREAD = 3,
    MIGRATION_PARAMETER_CPU_THROTTLE_INITIAL = 4,
    MIGRATION_PARAMETER_CPU_THROTTLE_INCREMENT = 5,
    MIGRATION_PARAMETER_TLS_CREDS = 6,
    MIGRATION_PARAMETER_TLS_HOSTNAME = 7,
    MIGRATION_PARAMETER_MAX_BANDWIDTH = 8,
    MIGRATION_PARAMETER_DOWNTIME_LIMIT = 9,
    MIGRATION_PARAMETER_X_CHECKPOINT_DELAY = 10,
    MIGRATION_PARAMETER_BLOCK_INCREMENTAL = 11,
    MIGRATION_PARAMETER_X_MULTIFD_CHANNELS = 12,
    MIGRATION_PARAMETER_X_MULTIFD_PAGE_COUNT = 13,
    MIGRATION_PARAMETER_XBZRLE_CACHE_SIZE = 14,
    MIGRATION_PARAMETER_MAX_POSTCOPY_BANDWIDTH = 15,
    MIGRATION_PARAMETER_MAX_CPU_THROTTLE = 16,
    MIGRATION_PARAMETER__MAX = 17,
} MigrationParameter;
...
typedef enum COLOExitReason {
    COLO_EXIT_REASON_NONE = 0,
    COLO_EXIT_REASON_REQUEST = 1,
    COLO_EXIT_REASON_ERROR = 2,
    COLO_EXIT_REASON__MAX = 3,
} COLOExitReason;
