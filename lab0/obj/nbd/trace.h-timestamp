...
static inline void _nocheck__trace_nbd_opt_go_start(const char * name)
{
    if (trace_event_get_state(TRACE_NBD_OPT_GO_START) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_opt_go_start " "Attempting NBD_OPT_GO for export '%s'" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name);
    }
...
static inline void _nocheck__trace_nbd_opt_go_success(void)
{
    if (trace_event_get_state(TRACE_NBD_OPT_GO_SUCCESS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_opt_go_success " "Export is good to go" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_nbd_opt_go_info_unknown(int info, const char * name)
{
    if (trace_event_get_state(TRACE_NBD_OPT_GO_INFO_UNKNOWN) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_opt_go_info_unknown " "Ignoring unknown info %d (%s)" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , info, name);
    }
...
static inline void _nocheck__trace_nbd_opt_go_info_block_size(uint32_t minimum, uint32_t preferred, uint32_t maximum)
{
    if (trace_event_get_state(TRACE_NBD_OPT_GO_INFO_BLOCK_SIZE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_opt_go_info_block_size " "Block sizes are 0x%" PRIx32 ", 0x%" PRIx32 ", 0x%" PRIx32 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_nbd_opt_meta_request(const char * context, const char * export)
{
    if (trace_event_get_state(TRACE_NBD_OPT_META_REQUEST) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_opt_meta_request " "Requesting to set meta context %s for export %s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , context, export);
    }
...
static inline void _nocheck__trace_nbd_opt_meta_reply(const char * context, uint32_t id)
{
    if (trace_event_get_state(TRACE_NBD_OPT_META_REPLY) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_opt_meta_reply " "Received mapping of context %s to id %" PRIu32 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , context, id);
    }
...
static inline void _nocheck__trace_nbd_receive_negotiate(void * tlscreds, const char * hostname)
{
    if (trace_event_get_state(TRACE_NBD_RECEIVE_NEGOTIATE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_receive_negotiate " "Receiving negotiation tlscreds=%p hostname=%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , tlscreds, hostname);
    }
...
static inline void _nocheck__trace_nbd_receive_negotiate_default_name(void)
{
    if (trace_event_get_state(TRACE_NBD_RECEIVE_NEGOTIATE_DEFAULT_NAME) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_receive_negotiate_default_name " "Using default NBD export name \"\"" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_nbd_negotiate_old_style(uint64_t size, unsigned flags)
{
    if (trace_event_get_state(TRACE_NBD_NEGOTIATE_OLD_STYLE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_negotiate_old_style " "advertising size %" PRIu64 " and flags 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , size, flags);
    }
...
static inline void _nocheck__trace_nbd_co_receive_request_cmd_write(uint32_t len)
{
    if (trace_event_get_state(TRACE_NBD_CO_RECEIVE_REQUEST_CMD_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_co_receive_request_cmd_write " "Reading %" PRIu32 " byte(s)" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , len);
    }
