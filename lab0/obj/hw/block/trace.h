...
static inline void _nocheck__trace_nvme_err_invalid_field(void)
{
    if (trace_event_get_state(TRACE_NVME_ERR_INVALID_FIELD) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err_invalid_field " "invalid field" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_nvme_err_invalid_sgl(void)
{
    if (trace_event_get_state(TRACE_NVME_ERR_INVALID_SGL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err_invalid_sgl " "invalid SGL" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_xen_disk_alloc(char * name)
{
    if (trace_event_get_state(TRACE_XEN_DISK_ALLOC) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_disk_alloc " "%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name);
    }
...
static inline void _nocheck__trace_xen_disk_init(char * name)
{
    if (trace_event_get_state(TRACE_XEN_DISK_INIT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_disk_init " "%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name);
    }
...
static inline void _nocheck__trace_xen_disk_connect(char * name)
{
    if (trace_event_get_state(TRACE_XEN_DISK_CONNECT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_disk_connect " "%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name);
    }
...
static inline void _nocheck__trace_xen_disk_disconnect(char * name)
{
    if (trace_event_get_state(TRACE_XEN_DISK_DISCONNECT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_disk_disconnect " "%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name);
    }
...
static inline void _nocheck__trace_xen_disk_free(char * name)
{
    if (trace_event_get_state(TRACE_XEN_DISK_FREE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_disk_free " "%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name);
    }
