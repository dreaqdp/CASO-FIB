...
extern TraceEvent _TRACE_SMMU_PAGE_WALK_EVENT;
extern TraceEvent _TRACE_SMMU_LOOKUP_TABLE_EVENT;
...
extern TraceEvent _TRACE_SMMUV3_UPDATE_EVENT;
extern TraceEvent _TRACE_SMMUV3_UPDATE_CHECK_CMD_EVENT;
extern TraceEvent _TRACE_SMMUV3_WRITE_MMIO_EVENT;
extern TraceEvent _TRACE_SMMUV3_WRITE_MMIO_IDR_EVENT;
extern TraceEvent _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_EVENT;
extern TraceEvent _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_EVENT;
...
extern uint16_t _TRACE_SMMU_PAGE_WALK_DSTATE;
extern uint16_t _TRACE_SMMU_LOOKUP_TABLE_DSTATE;
...
extern uint16_t _TRACE_SMMUV3_UPDATE_DSTATE;
extern uint16_t _TRACE_SMMUV3_UPDATE_CHECK_CMD_DSTATE;
extern uint16_t _TRACE_SMMUV3_WRITE_MMIO_DSTATE;
extern uint16_t _TRACE_SMMUV3_WRITE_MMIO_IDR_DSTATE;
extern uint16_t _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_DSTATE;
extern uint16_t _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_DSTATE;
...
#define TRACE_SMMU_PAGE_WALK_ENABLED 1
#define TRACE_SMMU_LOOKUP_TABLE_ENABLED 1
...
#define TRACE_SMMUV3_UPDATE_ENABLED 1
#define TRACE_SMMUV3_UPDATE_CHECK_CMD_ENABLED 1
#define TRACE_SMMUV3_WRITE_MMIO_ENABLED 1
#define TRACE_SMMUV3_WRITE_MMIO_IDR_ENABLED 1
#define TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_ENABLED 1
#define TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_ENABLED 1
...
#define TRACE_SMMU_PAGE_WALK_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMU_PAGE_WALK) || \
    false)

static inline void _nocheck__trace_smmu_page_walk(int stage, uint64_t baseaddr, int first_level, uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_SMMU_PAGE_WALK) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmu_page_walk " "stage=%d, baseaddr=0x%"PRIx64", first level=%d, start=0x%"PRIx64", end=0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , stage, baseaddr, first_level, start, end);
    }
}

static inline void trace_smmu_page_walk(int stage, uint64_t baseaddr, int first_level, uint64_t start, uint64_t end)
{
    if (true) {
        _nocheck__trace_smmu_page_walk(stage, baseaddr, first_level, start, end);
    }
}

#define TRACE_SMMU_LOOKUP_TABLE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMU_LOOKUP_TABLE) || \
    false)

static inline void _nocheck__trace_smmu_lookup_table(int level, uint64_t baseaddr, int granule_sz, uint64_t start, uint64_t end, int flags, uint64_t subpage_size)
{
    if (trace_event_get_state(TRACE_SMMU_LOOKUP_TABLE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmu_lookup_table " "level=%d baseaddr=0x%"PRIx64" granule=%d, start=0x%"PRIx64" end=0x%"PRIx64" flags=%d subpage_size=0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , level, baseaddr, granule_sz, start, end, flags, subpage_size);
    }
}

static inline void trace_smmu_lookup_table(int level, uint64_t baseaddr, int granule_sz, uint64_t start, uint64_t end, int flags, uint64_t subpage_size)
{
    if (true) {
        _nocheck__trace_smmu_lookup_table(level, baseaddr, granule_sz, start, end, flags, subpage_size);
    }
}
...
#define TRACE_SMMUV3_UPDATE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_UPDATE) || \
    false)

static inline void _nocheck__trace_smmuv3_update(bool is_empty, uint32_t prod, uint32_t cons, uint8_t prod_wrap, uint8_t cons_wrap)
{
    if (trace_event_get_state(TRACE_SMMUV3_UPDATE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_update " "q empty:%d prod:%d cons:%d p.wrap:%d p.cons:%d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , is_empty, prod, cons, prod_wrap, cons_wrap);
    }
}

static inline void trace_smmuv3_update(bool is_empty, uint32_t prod, uint32_t cons, uint8_t prod_wrap, uint8_t cons_wrap)
{
    if (true) {
        _nocheck__trace_smmuv3_update(is_empty, prod, cons, prod_wrap, cons_wrap);
    }
}

#define TRACE_SMMUV3_UPDATE_CHECK_CMD_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_UPDATE_CHECK_CMD) || \
    false)

static inline void _nocheck__trace_smmuv3_update_check_cmd(int error)
{
    if (trace_event_get_state(TRACE_SMMUV3_UPDATE_CHECK_CMD) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_update_check_cmd " "cmdq not enabled or error :0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , error);
    }
...
static inline void trace_smmuv3_update_check_cmd(int error)
{
    if (true) {
        _nocheck__trace_smmuv3_update_check_cmd(error);
    }
}
...
#define TRACE_SMMUV3_WRITE_MMIO_IDR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_WRITE_MMIO_IDR) || \
    false)

static inline void _nocheck__trace_smmuv3_write_mmio_idr(uint64_t addr, uint64_t val)
{
    if (trace_event_get_state(TRACE_SMMUV3_WRITE_MMIO_IDR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_write_mmio_idr " "write to RO/Unimpl reg 0x%"PRIx64" val64:0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, val);
    }
...
static inline void trace_smmuv3_write_mmio_idr(uint64_t addr, uint64_t val)
{
    if (true) {
        _nocheck__trace_smmuv3_write_mmio_idr(addr, val);
    }
}

#define TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR) || \
    false)

static inline void _nocheck__trace_smmuv3_write_mmio_evtq_cons_bef_clear(uint32_t prod, uint32_t cons, uint8_t prod_wrap, uint8_t cons_wrap)
{
    if (trace_event_get_state(TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_write_mmio_evtq_cons_bef_clear " "Before clearing interrupt prod:0x%x cons:0x%x prod.w:%d cons.w:%d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , prod, cons, prod_wrap, cons_wrap);
    }
...
static inline void trace_smmuv3_write_mmio_evtq_cons_bef_clear(uint32_t prod, uint32_t cons, uint8_t prod_wrap, uint8_t cons_wrap)
{
    if (true) {
        _nocheck__trace_smmuv3_write_mmio_evtq_cons_bef_clear(prod, cons, prod_wrap, cons_wrap);
    }
}

#define TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR) || \
    false)

static inline void _nocheck__trace_smmuv3_write_mmio_evtq_cons_after_clear(uint32_t prod, uint32_t cons, uint8_t prod_wrap, uint8_t cons_wrap)
{
    if (trace_event_get_state(TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_write_mmio_evtq_cons_after_clear " "after clearing interrupt prod:0x%x cons:0x%x prod.w:%d cons.w:%d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , prod, cons, prod_wrap, cons_wrap);
    }
...
static inline void trace_smmuv3_write_mmio_evtq_cons_after_clear(uint32_t prod, uint32_t cons, uint8_t prod_wrap, uint8_t cons_wrap)
{
    if (true) {
        _nocheck__trace_smmuv3_write_mmio_evtq_cons_after_clear(prod, cons, prod_wrap, cons_wrap);
    }
}
