...
uint16_t _TRACE_SMMU_PAGE_WALK_DSTATE;
uint16_t _TRACE_SMMU_LOOKUP_TABLE_DSTATE;
...
uint16_t _TRACE_SMMUV3_UPDATE_DSTATE;
uint16_t _TRACE_SMMUV3_UPDATE_CHECK_CMD_DSTATE;
uint16_t _TRACE_SMMUV3_WRITE_MMIO_DSTATE;
uint16_t _TRACE_SMMUV3_WRITE_MMIO_IDR_DSTATE;
uint16_t _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_DSTATE;
uint16_t _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_DSTATE;
...
TraceEvent _TRACE_SMMU_PAGE_WALK_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmu_page_walk",
    .sstate = TRACE_SMMU_PAGE_WALK_ENABLED,
    .dstate = &_TRACE_SMMU_PAGE_WALK_DSTATE 
};
TraceEvent _TRACE_SMMU_LOOKUP_TABLE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmu_lookup_table",
    .sstate = TRACE_SMMU_LOOKUP_TABLE_ENABLED,
    .dstate = &_TRACE_SMMU_LOOKUP_TABLE_DSTATE 
};
...
TraceEvent _TRACE_SMMUV3_UPDATE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_update",
    .sstate = TRACE_SMMUV3_UPDATE_ENABLED,
    .dstate = &_TRACE_SMMUV3_UPDATE_DSTATE 
};
TraceEvent _TRACE_SMMUV3_UPDATE_CHECK_CMD_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_update_check_cmd",
    .sstate = TRACE_SMMUV3_UPDATE_CHECK_CMD_ENABLED,
    .dstate = &_TRACE_SMMUV3_UPDATE_CHECK_CMD_DSTATE 
};
...
TraceEvent _TRACE_SMMUV3_WRITE_MMIO_IDR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_write_mmio_idr",
    .sstate = TRACE_SMMUV3_WRITE_MMIO_IDR_ENABLED,
    .dstate = &_TRACE_SMMUV3_WRITE_MMIO_IDR_DSTATE 
};
TraceEvent _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_write_mmio_evtq_cons_bef_clear",
    .sstate = TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_ENABLED,
    .dstate = &_TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_DSTATE 
};
TraceEvent _TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_write_mmio_evtq_cons_after_clear",
    .sstate = TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_ENABLED,
    .dstate = &_TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_DSTATE 
};
...
TraceEvent *hw_arm_trace_events[] = {
    ...
    &_TRACE_SMMU_PAGE_WALK_EVENT,
    &_TRACE_SMMU_LOOKUP_TABLE_EVENT,
    ...
    &_TRACE_SMMUV3_UPDATE_EVENT,
    &_TRACE_SMMUV3_UPDATE_CHECK_CMD_EVENT,
    &_TRACE_SMMUV3_WRITE_MMIO_EVENT,
    &_TRACE_SMMUV3_WRITE_MMIO_IDR_EVENT,
    &_TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_BEF_CLEAR_EVENT,
    &_TRACE_SMMUV3_WRITE_MMIO_EVTQ_CONS_AFTER_CLEAR_EVENT,
