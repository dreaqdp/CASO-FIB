...
uint16_t _TRACE_TZ_MSC_IRQ_ENABLE_DSTATE;
...
TraceEvent _TRACE_TZ_MSC_IRQ_ENABLE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "tz_msc_irq_enable",
    .sstate = TRACE_TZ_MSC_IRQ_ENABLE_ENABLED,
    .dstate = &_TRACE_TZ_MSC_IRQ_ENABLE_DSTATE 
};
...
TraceEvent *hw_misc_trace_events[] = {
    ...
    &_TRACE_TZ_MSC_IRQ_ENABLE_EVENT,
