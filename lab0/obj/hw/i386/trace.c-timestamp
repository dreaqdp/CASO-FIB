...
uint16_t _TRACE_AMDVI_IR_GENERATE_MSI_MESSAGE_DSTATE;
uint16_t _TRACE_AMDVI_IR_IRTE_GA_DSTATE;
...
TraceEvent _TRACE_AMDVI_IR_GENERATE_MSI_MESSAGE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "amdvi_ir_generate_msi_message",
    .sstate = TRACE_AMDVI_IR_GENERATE_MSI_MESSAGE_ENABLED,
    .dstate = &_TRACE_AMDVI_IR_GENERATE_MSI_MESSAGE_DSTATE 
};
TraceEvent _TRACE_AMDVI_IR_IRTE_GA_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "amdvi_ir_irte_ga",
    .sstate = TRACE_AMDVI_IR_IRTE_GA_ENABLED,
    .dstate = &_TRACE_AMDVI_IR_IRTE_GA_DSTATE 
};
...
TraceEvent *hw_i386_trace_events[] = {
    ...
    &_TRACE_AMDVI_IR_GENERATE_MSI_MESSAGE_EVENT,
    &_TRACE_AMDVI_IR_IRTE_GA_EVENT,
