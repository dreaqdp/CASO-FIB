...
static inline void _nocheck__trace_spapr_irq_alloc(int irq)
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_ALLOC) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_irq_alloc " "irq %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , irq);
    }
...
static inline void _nocheck__trace_spapr_irq_alloc_block(int first, int num, bool lsi, int align)
{
    if (trace_event_get_state(TRACE_SPAPR_IRQ_ALLOC_BLOCK) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_irq_alloc_block " "first irq %d, %d irqs, lsi=%d, alignnum %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , first, num, lsi, align);
    }
...
static inline void _nocheck__trace_spapr_cas_pvr_try(uint32_t pvr)
{
    if (trace_event_get_state(TRACE_SPAPR_CAS_PVR_TRY) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_cas_pvr_try " "0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , pvr);
    }
...
static inline void _nocheck__trace_spapr_drc_set_isolation_state_deferring(uint32_t index)
{
    if (trace_event_get_state(TRACE_SPAPR_DRC_SET_ISOLATION_STATE_DEFERRING) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_drc_set_isolation_state_deferring " "drc: 0x%"PRIx32 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index);
    }
...
static inline void _nocheck__trace_spapr_drc_set_configured_skipping(uint32_t index)
{
    if (trace_event_get_state(TRACE_SPAPR_DRC_SET_CONFIGURED_SKIPPING) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_drc_set_configured_skipping " "drc: 0x%"PRIx32", isolated device" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index);
    }
...
static inline void _nocheck__trace_spapr_drc_awaiting_allocation(uint32_t index)
{
    if (trace_event_get_state(TRACE_SPAPR_DRC_AWAITING_ALLOCATION) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_drc_awaiting_allocation " "drc: 0x%"PRIx32 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index);
    }
...
static inline void _nocheck__trace_spapr_rtas_ibm_configure_connector_missing_fdt(uint32_t index)
{
    if (trace_event_get_state(TRACE_SPAPR_RTAS_IBM_CONFIGURE_CONNECTOR_MISSING_FDT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_rtas_ibm_configure_connector_missing_fdt " "DRC index: 0x%"PRIx32 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index);
    }
...
static inline void _nocheck__trace_ppc440_pcix_reg_write(uint64_t addr, uint64_t val)
{
    if (trace_event_get_state(TRACE_PPC440_PCIX_REG_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:ppc440_pcix_reg_write " "addr 0x%" PRIx64 " = 0x%" PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, val);
    }
