...
static inline void _nocheck__trace_lsi_execute_script_blockmove_badphase(uint8_t phase, uint8_t expected)
{
    if (trace_event_get_state(TRACE_LSI_EXECUTE_SCRIPT_BLOCKMOVE_BADPHASE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:lsi_execute_script_blockmove_badphase " "Wrong phase got %d expected %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , phase, expected);
    }
...
static inline void trace_lsi_execute_script_blockmove_badphase(uint8_t phase, uint8_t expected)
{
    if (true) {
...
static inline void _nocheck__trace_lsi_execute_script_tc_compp(uint8_t phase, int op, uint8_t insn_phase)
{
    if (trace_event_get_state(TRACE_LSI_EXECUTE_SCRIPT_TC_COMPP) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:lsi_execute_script_tc_compp " "Compare phase %d %c= %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , phase, op, insn_phase);
    }
...
static inline void trace_lsi_execute_script_tc_compp(uint8_t phase, int op, uint8_t insn_phase)
{
    if (true) {
...
static inline void _nocheck__trace_lsi_execute_script_tc_compd(uint32_t sfbr, uint8_t mask, int op, int result)
{
...
static inline void trace_lsi_execute_script_tc_compd(uint32_t sfbr, uint8_t mask, int op, int result)
{
    if (true) {
