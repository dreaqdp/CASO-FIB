...
uint16_t _TRACE_FILE_PAIO_SUBMIT_CO_DSTATE;
...
TraceEvent _TRACE_FILE_PAIO_SUBMIT_CO_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "file_paio_submit_co",
    .sstate = TRACE_FILE_PAIO_SUBMIT_CO_ENABLED,
    .dstate = &_TRACE_FILE_PAIO_SUBMIT_CO_DSTATE 
};
...
TraceEvent *block_trace_events[] = {
    ...
    &_TRACE_FILE_PAIO_SUBMIT_CO_EVENT,
