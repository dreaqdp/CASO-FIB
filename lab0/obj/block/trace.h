...
extern TraceEvent _TRACE_FILE_PAIO_SUBMIT_CO_EVENT;
...
extern uint16_t _TRACE_FILE_PAIO_SUBMIT_CO_DSTATE;
...
#define TRACE_FILE_PAIO_SUBMIT_CO_ENABLED 1
...
#define TRACE_FILE_PAIO_SUBMIT_CO_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_FILE_PAIO_SUBMIT_CO) || \
    false)

static inline void _nocheck__trace_file_paio_submit_co(int64_t offset, int count, int type)
{
    if (trace_event_get_state(TRACE_FILE_PAIO_SUBMIT_CO) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:file_paio_submit_co " "offset %"PRId64" count %d type %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , offset, count, type);
    }
...
static inline void trace_file_paio_submit_co(int64_t offset, int count, int type)
{
    if (true) {
        _nocheck__trace_file_paio_submit_co(offset, count, type);
    }
}
